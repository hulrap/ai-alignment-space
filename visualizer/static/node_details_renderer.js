...
class NodeDetailsRenderer {
    ...
    // Helper to create a cosmic-styled node title
    createCosmicNodeTitle(nodeName) {
        return `
            <div class="node-cosmic-title">
    ...
    displayGeneric(nodeData) {
        ...
        // Add cosmic-styled title
        html += this.createCosmicNodeTitle(nodeData.name || nodeData.id || "Unknown Node");
